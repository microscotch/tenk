...
`pre-push` qui incrémente le numéro de build, les jobs de la CI (dont `test-server`), le workflow qui publie l'image Docker du serveur sur ghcr.io, les artefacts, Google Play (piste
